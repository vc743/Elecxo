  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-white px-4 shadow-sm">
            ...
            >
              ...
              {cartCount === 0 ? null : (
                <motion.div
                  ...
                  className="flex justify-center items-center absolute font-semibold text-xs text-white h-4 w-4 bg-[#58A0E2] rounded top-0 right-0 transform translate-x-1 -translate-y-1"
                >
                  {cartCount}
                </motion.div>
              )}
        ...
        {/* Category Bar */}
        <div
          className={`md:block max-w-xl mx-auto py-4 ${
        ...
        >
          <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
            ...
            border md:border-none hover:bg-gray-100 hover:border-gray-200 ${
